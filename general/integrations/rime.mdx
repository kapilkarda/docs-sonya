---
title: Rime
description: "Bring your Rime voice capabilities to Ai for lifelike conversations."
---
...
<ul>
    ...
    <li>After obtaining your Rime API Key, go to the Integration section in Ai and paste your API key into the Rime integration field.</li>

    <li>Save the integration settings to establish a secure connection with Rime.</li>

</ul>

## Configure Your Agent with Rime Voices

<ul>

    <li>Navigate to Agent Settings within Ai.</li>
    ...
    <li>Adjust tone, speed, and emotional expression per your agent’s use case.</li>

    <li>Save your agent settings to finalize the voice customization.</li>

</ul>


Now your Ai voice agents are powered by Rime, delivering smooth, natural, and engaging conversations.
