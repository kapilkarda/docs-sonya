---
title: LMNT
description: "Bring your LMNT voice capabilities to Ai for lifelike conversations."
---
...
<ul>
    ...
    <li>Now, head over to your Ai dashboard, go to the Integrations section, and select LMNT.</li>

    <li>Paste the copied API key into the provided field and click Save to successfully link LMNT with Ai.</li>

</ul>

## Configure LMNT Voice Settings in Ai

<ul>

    <li>Navigate to Agent Settings within your Ai account.</li>
...
Your AI voice agents are now powered by LMNT’s advanced speech synthesis, ensuring fast, realistic, and engaging conversations for every customer interaction.
