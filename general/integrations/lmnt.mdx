---
title: LMNT
description: "Bring your LMNT voice capabilities to Bolify AI for lifelike conversations."
---
...
<ul>
    ...
    <li>Now, head over to your Bolify AI dashboard, go to the Integrations section, and select LMNT.</li>

    <li>Paste the copied API key into the provided field and click Save to successfully link LMNT with Bolify AI.</li>

</ul>

## Configure LMNT Voice Settings in Bolify AI

<ul>

    <li>Navigate to Assistant Settings within your Bolify AI account.</li>
