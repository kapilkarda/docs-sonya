---
title: Neuphonic
description: "Bring your Neuphonic voice capabilities to Ai for lifelike conversations."
---
...
<ul>
    ...
    <li>Go to the Integrations tab within your Ai account.</li>
...
## Configure Your Voice Agent with Neuphonic Voices

<ul>

    <li>Navigate to Agent Settings in your Ai dashboard.</li>
    ...
    <li>If you’ve created custom voices on Neuphonic, you can link and use them directly within Ai.</li>

    <li>Once done, click Save Settings to activate Neuphonic’s voice on your agent.</li>

</ul>


Now your Ai agent will engage users with lifelike, emotionally rich voices, powered by Neuphonic's advanced AI speech synthesis.
