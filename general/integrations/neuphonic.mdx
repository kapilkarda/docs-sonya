---
title: Neuphonic
description: "Bring your Neuphonic voice capabilities to Bolify AI for lifelike conversations."
---
...
<ul>
    ...
    <li>Go to the Integrations tab within your Bolify AI account.</li>
...
<ul>
    ...
    <li>Navigate to Assistant Settings in your Bolify AI dashboard.</li>
    ...
    <li>If you’ve created custom voices on Neuphonic, you can link and use them directly within Bolify AI.</li>
...
Now your Bolify AI assistant will engage users with lifelike, emotionally rich voices, powered by Neuphonic's advanced AI speech synthesis.
