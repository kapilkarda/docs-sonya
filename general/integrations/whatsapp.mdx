...
## Here are the steps to connect your Ai account with WhatsApp.
...
To obtain both the WhatsApp Access Token and WhatsApp Business ID, please follow the process by clicking [here](https://bolify.mintlify.app/general/integrations/whatsappBusinessApiSetup).
