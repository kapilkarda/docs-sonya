...
description: "Learn how to configure Zeplo WhatsApp templates, parameter hints, and send messages from Ai assistants."
---

## Zeplo Template Configuration in Ai

Once your Zeplo credentials are configured (see [Zeplo Setup Guide](/general/integrations/zeploSetup)), you can use WhatsApp templates in your Ai assistants to send automated messages.
