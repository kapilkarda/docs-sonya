...
## Here are the steps to connect your Bolify AI account with Salesforce.
...
6. Complete the steps to connect your Bolify AI account with Salesforce.

Once you have completed these steps, your Bolify AI account will be integrated with Salesforce allowing you to sync data.
