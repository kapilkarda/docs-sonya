...
## Here are the steps to connect your Ai account with Salesforce.
...
6. Complete the steps to connect your Ai account with Salesforce.

Once you have completed these steps, your Ai account will be integrated with Salesforce allowing you to sync data.
