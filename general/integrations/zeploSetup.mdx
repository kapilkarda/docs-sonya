...
description: "Step-by-step guide to create a Zeplo account, connect WhatsApp, and generate API credentials for Ai integration."
---

## Step-by-Step Zeplo Setup

This guide walks you through creating a Zeplo account, connecting your WhatsApp Business channel, and generating the API credentials needed for Ai integration.
...
4. Save this value — you'll need it for the Ai configuration.
...
### Step 7: Configure Zeplo in Ai

Now that you have your credentials from Zeplo, configure them in Ai:

1. Log in to the **Ai dashboard**.
2. Click the **Ai logo** in the top left corner to open the menu.
...
After saving your Zeplo credentials in Ai:
