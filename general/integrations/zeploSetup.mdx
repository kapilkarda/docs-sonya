...
description: "Step-by-step guide to create a Zeplo account, connect WhatsApp, and generate API credentials for Bolify AI integration."
---

## Step-by-Step Zeplo Setup

This guide walks you through creating a Zeplo account, connecting your WhatsApp Business channel, and generating the API credentials needed for Bolify AI integration.
...
4. Save this value — you'll need it for the Bolify AI configuration.
...
3. Enter a name for the key (e.g., "Bolify Integration").
...
### Step 7: Configure Zeplo in Bolify AI

Now that you have your credentials from Zeplo, configure them in Bolify AI:

1. Log in to the **Bolify AI dashboard**.
2. Click the **Bolify AI logo** in the top left corner to open the menu.
...
After saving your Zeplo credentials in Bolify AI:
