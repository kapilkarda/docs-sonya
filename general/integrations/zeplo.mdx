...
description: "Connect Ai with Zeplo to send WhatsApp messages via templates during and after calls."
---

## Zeplo — WhatsApp Messaging for Ai

Zeplo is a WhatsApp marketing and messaging platform that integrates with Ai to send automated WhatsApp messages during your AI-powered call workflows. With Zeplo, you can:
...
Ai uses three credentials from your Zeplo account:
...
## Required Keys for Agent Setup

When creating an agent with a **Send Message** action, you need these Zeplo fields:
...
<Note>
The **API Key**, **API Secret**, and **Channel ID** are configured once in **Integrations → Zeplo**. The **Template**, **Parameter Hints**, and **Condition Text** are configured per agent Send Message action.
</Note>
...
2. [Zeplo Template Configuration](/general/integrations/zeploTemplates) — Configure templates and parameter hints in Ai
