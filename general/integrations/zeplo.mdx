...
description: "Connect Bolify AI with Zeplo to send WhatsApp messages via templates during and after calls."
---

## Zeplo — WhatsApp Messaging for Bolify AI

Zeplo is a WhatsApp marketing and messaging platform that integrates with Bolify AI to send automated WhatsApp messages during your AI-powered call workflows. With Zeplo, you can:
...
Bolify AI uses three credentials from your Zeplo account:
...
2. [Zeplo Template Configuration](/general/integrations/zeploTemplates) — Configure templates and parameter hints in Bolify AI
