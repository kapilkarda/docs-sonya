...
2. To manage the CRM sync Action, go to the Ai dashboard click on the assistant field and update your assistant setting by clicking on the new assistant button.
