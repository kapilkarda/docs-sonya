...
Bolify AI uses **Zeplo** to send WhatsApp messages. Before using this feature, make sure you have configured your Zeplo credentials in **Integrations → Zeplo** (see [Zeplo Setup Guide](/general/integrations/zeploSetup)).
...
### Here are the steps to sync data between Bolify Ai and your CRM (HubSpot, Salesforce and Zapier Hook):

1. After making an outbound or inbound call in Bolify Ai, the call data will be automatically updated in your connected CRM platform(s).

2. To manage the CRM sync Action, go to the Bolify Ai dashboard click on the assistant field and update your assistant setting by clicking on the new assistant button.
...
Then, All call data from your outbound or inbound calls in Bolify Ai will be automatically synced to your connected HubSpot, Salesforce or Zapier Hook CRM.

### Zapier Hook.

Bolify Ai lets you set up actions like booking appointments and sending links through Zapier. Too many actions can confuse the AI, so keep the number of actions small for the best results.

To integrate Bolify Ai with Zapier Hook, follow these steps: 
...
By following these steps, you can integrate Bolify Ai with Zapier and set up automated actions through the Zapier platform.
