...
description: "Agents are bots that are created to be used in campaigns to talk to your contacts and achieve your goals on your behalf."
---
...
<b>Agent Image:</b> Choose an image for the agent.

<b>Goal:</b> Select the agent's goal.
...
<b>Voice Note:</b> This option will be activated when your call fails. It is visible only when you create an outbound agent. If you are creating an inbound agent, this option will not be displayed.
...
<b>Script:</b> Use created templates, and scripts from the AI agent, or write them manually.
