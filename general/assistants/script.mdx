...
<Note>
  ...
  follow while writing scripts for your agents, use the templates available
  for reference.
</Note>

Steps to set Script for your Agent : <br/> Click on the Agent ( as shown ion the below screenshot) for the agent you want to set the script for.
...
<span style={{ fontWeight: 800 }}>
  Congratulations you have successfully added Script of your Agent !! 👏👏
</span>
