...
description: "This document explains how to configure and receive webhooks from the **AI** platform. A webhook lets your AI assistant forward collected call information to your own server or any 3rd-party service (CRM, Zapier, Make, your API, Google Sheets, etc.) in real time."
---


## 1. Overview

AI supports **two webhook trigger modes**. You configure them from the **Tools** section of your assistant inside the AI Dashboard.
