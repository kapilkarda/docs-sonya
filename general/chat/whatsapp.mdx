---
title: WhatsApp Chat
description: "This page describes how to use WhatsApp chat with Ai via Zeplo"
icon: "message-square"
---

## WhatsApp Chat

Ai integrates with WhatsApp through **Zeplo**, enabling you to send WhatsApp messages using approved templates. This is perfect for sending booking confirmations, reminders, follow-ups, and notifications.
...
You can configure your agent to send WhatsApp messages during or after a call using the **sendMessage** action with Zeplo configuration.
