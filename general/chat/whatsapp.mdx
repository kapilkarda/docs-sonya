---
title: WhatsApp Chat
description: "This page describes how to use WhatsApp chat with Bolify AI via Zeplo"
icon: "message-square"
---

## WhatsApp Chat

Bolify AI integrates with WhatsApp through **Zeplo**, enabling you to send WhatsApp messages using approved templates. This is perfect for sending booking confirmations, reminders, follow-ups, and notifications.
