...
description: "This page describes how to embed and configure the Ai chat widget on your website"
icon: "globe"
---

## Web Chat Widget

Ai provides a customizable chat widget that you can embed on your website to engage visitors in real-time AI-powered conversations. The widget connects directly to your configured agent, providing instant responses to visitor queries.
...
### Step 1: Enable Widget in Agent Settings

1. Navigate to **Agent Settings** under Call Platforms
...
<script>
  (function(w, d, s, o) {
    ...
    js.src = 'https://widget.domain.ai/widget.js';
...
```html
<div id="widget-chat-container" style="width: 400px; height: 600px;"></div>
...
<script>
  (function(w, d, s, o) {
    ...
    js.setAttribute('data-container-id', 'widget-chat-container');
    d.head.appendChild(js);
  })(window, document, 'script');
</script>
```
...
You can also configure the widget programmatically when creating or updating an agent:
...
- **Colors**: The widget inherits your agent's primary color (`#7C53FC` by default)
- **Welcome Message**: Configure the initial greeting in your agent's start speech
- **Language**: The widget supports all languages configured for your agent
