...
description: "This page describes how to embed and configure the Bolify AI chat widget on your website"
icon: "globe"
---

## Web Chat Widget

Bolify AI provides a customizable chat widget that you can embed on your website to engage visitors in real-time AI-powered conversations. The widget connects directly to your configured assistant, providing instant responses to visitor queries.
