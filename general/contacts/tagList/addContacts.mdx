...
The process of adding contacts to a [contact list](https://login.bolifyai.com/admin/tags) is as quite simple. <br/> We can bulk upload contacts to a tag list via a .csv file or we can add the contacts manually.
