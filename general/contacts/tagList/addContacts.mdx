...
description: "This page will teach us how to add contacts to the group list"
icon: "people"
---

The process of adding contacts to a [contact list](https://login.bolifyai.com/admin/tags) is as quite simple. <br/> We can bulk upload contacts to a group list via a .csv file or we can add the contacts manually.
...
✔ Click on the Name of the group list , that you want to add the contacts to.
