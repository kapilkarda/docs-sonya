...
## Here are the steps to connect your Ai account with Hubspot and Salesforce.
...
6. Complete the steps to connect your Ai account with HubSpot and Salesforce.

Once you have completed these steps, your Ai account will be integrated with HubSpot and Salesforce allowing you to sync data between the two platforms.

## Here are the steps to sync data between Ai and your CRM (HubSpot and Salesforce):
...
Then, All call data from your outbound or inbound calls in Ai will be automatically synced to your connected HubSpot or Salesforce CRM.
...
Once completed, save the configuration. You can then use this SMTP template in the Agent option to send emails.
