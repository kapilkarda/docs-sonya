...
## Here are the steps to connect your Bolify AI account with Hubspot and Salesforce.
...
6. Complete the steps to connect your Bolify AI account with HubSpot and Salesforce.

Once you have completed these steps, your Bolify AI account will be integrated with HubSpot and Salesforce allowing you to sync data between the two platforms.

## Here are the steps to sync data between Bolify AI and your CRM (HubSpot and Salesforce):
...
Then, All call data from your outbound or inbound calls in Bolify AI will be automatically synced to your connected HubSpot or Salesforce CRM.
