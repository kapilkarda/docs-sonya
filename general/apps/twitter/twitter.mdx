...
<Info>
    This page explains the steps you need to follow to set up the Twitter connection in Bolify AI. If any of the steps are outdated, please let us know!
</Info>
...
11. Copy **OAuth Redirect URL** from Bolify AI and paste it to the **Callback URI / Redirect URL** field.
12. Fill **Website URL** and click **Save**.
13. Paste **API Key** and **API Key Secret** values you have saved from the 5th step and paste them into Bolify AI as **API Key** and **API Secret**, respectively.
