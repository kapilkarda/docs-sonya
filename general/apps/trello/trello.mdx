...
6. Copy **OAuth Redirect URL** from Bolify AI and paste it in **Allowed origins** and click on the **Add** button.
7. Copy the **API key** value to the **API key** field on Bolify AI.
