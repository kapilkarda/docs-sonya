...
5. Copy **OAuth Redirect URL** from Bolify AI to the **Callback URLs** field on Mattermost page.
6. Click on the **Save** button at the end of the form on Mattermost page.
7. Copy the **Client ID** value from the following page to the `Client ID` field on Bolify AI.
8. Copy the **Client Secret** value from the same page to the `Client Secret` field on Bolify AI.
9. Click **Done** button on MAttermost page.
10. Click **Submit** button on Bolify AI.
