...
9. Copy **OAuth Redirect URL** from Bolify AI to **Redirect URLs** field in the form.
10. Enter your preferred client ID value in **Unique Identifier** field.
11. Save the form to complete creating the OAuth client.
12. Copy the `Unique identifier` value from the page to the `Client ID` field on Bolify AI.
13. Copy the `Secret` value from the page to the `Client Secret` field on Bolify AI.
14. Now, you can start using the Zendesk connection with Bolify AI.
