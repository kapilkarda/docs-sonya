...
1. Copy **OAuth Redirect URL** from Bolify AI and paste it to the **Callback URL** field.
...
1. Copy the **Consumer Key** value from the page to the `Consumer Key` field on Bolify AI.
1. Copy the **Consumer Secret** value from the page to the `Consumer Secret` field on Bolify AI.
1. Click **Submit** button on Bolify AI.
1. Now, you can start using the Salesforce connection with Bolify AI.
