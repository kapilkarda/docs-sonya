...
6. Copy **OAuth Redirect URL** from Bolify AI to **Callback URL** field.
7. Click on the **Save Changes** button.
8. Go to the **Details** tab.
9. Copy **API Key** to **API Key** field on Bolify AI.
10. Copy **API Secret** to **API Secret** field on Bolify AI.
