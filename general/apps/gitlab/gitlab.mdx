...
3. Copy **OAuth Redirect URL** from Bolify AI to **Redirect URI** field on Gitlab page.
...
7. Copy the **Application ID** value from the following page to the `Client ID` field on Bolify AI.
8. Copy the **Secret** value from the same page to the `Client Secret` field on Bolify AI.
