...
1. Copy **OAuth Redirect URL** from Bolify AI to **Redirect URIs** field and add it.
...
1. Copy **App key** to **App key** field on Bolify AI.
1. Copy **App secret** to **App secret** field on Bolify AI.
