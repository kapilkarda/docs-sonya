...
6. Copy the token from the popup to the `API Key` field on Bolify AI.
7. Write any screen name to be displayed in Bolify AI.
8. Now, you can start using the MailerLite connection with Bolify AI.
