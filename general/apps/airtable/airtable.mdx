...
4. Copy **OAuth Redirect URL** from Bolify AI to **OAuth redirect URL** field.
...
9. Copy **Client ID** to **Client ID** field on Bolify AI.
10. Copy **Client secret** to **Client secret** field on Bolify AI.
