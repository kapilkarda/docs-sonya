...
6. Copy **OAuth Redirect URL** from Bolify AI to **Redirect URI** field, and click on the **Create** button.
7. Copy the **Your Client ID** value to the `Client ID` field on Bolify AI.
8. Copy the **Your Client Secret** value to the `Client Secret` field on Bolify AI.
