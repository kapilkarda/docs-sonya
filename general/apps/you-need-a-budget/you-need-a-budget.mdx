...
6. Copy **OAuth Redirect URL** from Bolify AI and paste it in **Redirect URI(s)** section.
...
9. Copy the **Client ID** value to the **Client ID** field on Bolify AI.
10. Copy the **Client Secret** value to the **Client Secret** field on Bolify AI.
11. Fill the **Screen Name** field on Bolify AI.
