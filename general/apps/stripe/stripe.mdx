...
<Info>
    This page explains the steps you need to follow to set up the Stripe connection in Bolify AI. If any of the steps are outdated, please let us know!
</Info>
...
3. Paste the **Secret key** in the named field in Bolify AI and assign a display name for the connection.
