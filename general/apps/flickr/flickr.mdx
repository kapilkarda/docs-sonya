...
10. Copy **OAuth Redirect URL** from Bolify AI and paste it to the **Callback URL** field.
11. Click **Save changes**.
12. Paste **Key** and **Secret** values you have saved from the 8th step and paste them into Bolify AI as **Consumer Key** and **Consumer Secret**, respectively.
13. Click **Submit** button on Bolify AI.
14. Now, you can start using the Flickr connection with Bolify AI.
