...
1. Copy **OAuth Redirect URL** from Bolify AI and paste it to the **Redirect URIs** field.
1. Click on the **Submit** button.
1. Accept making the integration public by clicking on the **Continue** button in the dialog.
1. Copy **OAuth client ID** and **OAuth client secret** values and paste them into Bolify AI as **Client ID** and **Client Secret**, respectively.
1. Click **Submit** button on Bolify AI.
1. Now, you can start using the Notion connection with Bolify AI.
