...
<Info>
    This page explains the steps you need to follow to set up a VirtualQ connection in Bolify AI. If any of the steps are outdated, please let us know!
</Info>
...
5. Copy the shown token and paste it to the **API Key** field on the Bolify AI connection creation page.
