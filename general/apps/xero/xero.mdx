...
5. Copy **OAuth Redirect URL** from Bolify AI to **Redirect URL** field.
...
10. Copy the **Client secret 1** value to the `Client Secret` field on Bolify AI.
11. Start using Xero integration with Bolify AI!
